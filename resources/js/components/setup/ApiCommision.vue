...
export default {
    ...
    methods: {
        async update() {
            try {
                this.loading = true;
                const response = await axios.post(`/apidata/apicommissionupdate`, this.apiData);
        ...
        async getData() {
            ...
            const response = await axios.get(`/apidata/apicommission/${option1}/${option2}`);
